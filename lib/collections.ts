...
export const COLLECTIONS: Record<CollectionSlug, CollectionConfig> = {
  signature: {
    ...
    imageSrc: "/signature-banner.webp",
  ...
  heritage: {
    ...
    imageSrc: `https://images.unsplash.com/photo-1571896349842-33c89424de2d?${q}`,
    imageAlt: "Resort-inspired tailoring and drape",
    heroKicker: "Lineage",
    tagline: "Tradition, translated for today.",
    intro:
      "Heritage weaves archival motifs into modern proportion—rich texture, a restrained palette, and silhouettes that respect the body.",
    spotlight: {
  ...
  florance: {
    ...
    imageSrc: `https://images.unsplash.com/photo-1519741497674-611481863552?${q}`,
    imageAlt: "Bridal portrait in natural light",
    heroKicker: "Occasion",
